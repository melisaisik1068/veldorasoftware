...
export const metadata: Metadata = {
  ...
  description: '5 yıllık Next.js 16 ve TypeScript uzmanlığıyla kurumsal yazılım mimarisi. Ölçeklenebilir, hızlı ve güvenilir full-stack çözümler.',
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            foundingDate: '2021',
            knowsAbout: ['Next.js', 'TypeScript', 'React', 'Full-Stack Development', 'Cloud Architecture'],
