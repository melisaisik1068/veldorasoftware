...
export default function TechBentoSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 px-6 bg-background relative">
      {/* Section header */}
      <div className="max-w-7xl mx-auto mb-12">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
          ...
          <p className="text-muted-foreground max-w-sm text-sm leading-relaxed">
            Her teknoloji seçimi bilinçli bir mimari karardır. Hız, tip güvenliği ve
            ölçeklenebilirlik için en iyi araçları kullanıyorum.
          </p>
        </div>
      </div>
      {/* Bento Grid */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse at top left, #2563EB 0%, transparent 60%)',
            }}
          />
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              App Router, Server Components, Edge Runtime ve ISR ile sıfır-bundle-size yaklaşımı.
              Her katmanda tip güvenliği.
            </p>
          </div>
          {/* Skill bars */}
            ...
            {techStack?.slice(0, 3)?.map((tech) => (
              <div key={tech?.name}>
                <div className="flex justify-between text-xs mb-1.5">
                  ...
                  <span style={{ color: tech?.color }} className="font-semibold">
                    {tech?.level}%
                  </span>
                </div>
        ...
        >
          ...
          <div className="font-display text-5xl font-semibold text-foreground mb-2">5+</div>
          <div className="text-sm text-muted-foreground">Yıllık production deneyimi</div>
        ...
        >
          ...
          <div className="font-display text-xl font-semibold text-foreground">Next.js 16</div>
          <div className="text-xs text-muted-foreground mt-1">App Router uzmanı</div>
        </div>
        ...
        >
          <div className="w-10 h-10 rounded-lg bg-blue-600/20 flex items-center justify-center mb-4">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              ...
              <path
                d="M13.5 15v-1.5H16.5V15H15.5V19H14V15H13.5ZM7 13.5H12V15H10.25V19H8.75V15H7V13.5Z"
                fill="white"
              />
            </svg>
          </div>
          <div className="font-display text-xl font-semibold text-foreground">TypeScript</div>
          <div className="text-xs text-muted-foreground mt-1">Strict mode, her zaman</div>
        </div>
        ...
        >
          ...
          <div className="font-display text-xl font-semibold text-foreground">Cloud & DevOps</div>
          <div className="text-xs text-muted-foreground mt-1">Vercel, GCP, AWS</div>
        </div>
        ...
        >
          <div className="text-xs text-accent uppercase tracking-widest font-semibold mb-2">
            Projeler
          </div>
          <div className="font-display text-5xl font-semibold text-foreground">40+</div>
          <div className="text-sm text-muted-foreground mt-2">Production&apos;da çalışan</div>
        </div>
        ...
        >
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Her proje Google Core Web Vitals&apos;ta 100 Lighthouse skoru hedefiyle çıkar. ISR +
              Edge Runtime kombinasyonu ile.
            </p>
          </div>
