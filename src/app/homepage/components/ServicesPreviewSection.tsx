...
export default function ServicesPreviewSection() {
  return (
    <section className="py-16 px-6 bg-[#030810] relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-2/5 lg:sticky lg:top-28">
            <p className="text-xs text-accent uppercase tracking-widest font-semibold mb-4">Hizmetler</p>
            ...
            <p className="text-[#64748B] text-sm leading-relaxed mb-8 max-w-xs">
              Startup MVP&apos;sinden kurumsal platforma kadar, her ölçekteki yazılım projesinde mimari danışmanlık ve geliştirme.
            </p>

            {/* Stat block to fill column */}
            <div className="glass rounded-2xl p-6 mb-6">
              <div className="text-3xl font-display font-semibold text-white mb-1">%100</div>
              ...
              <div className="mt-4 text-3xl font-display font-semibold text-white mb-1">3x</div>
            ...
            {services?.map((svc, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#0A1628] flex items-center justify-center shrink-0 border border-[#1E3A5F]/50">
                    {svc?.icon}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-display text-lg font-semibold text-white">{svc?.title}</h3>
                      <span className="text-xs text-muted-foreground bg-[#0F172A] px-3 py-1 rounded-full border border-[#1E3A5F]/40 hidden sm:block">
                        {svc?.badge}
                      </span>
                    </div>
