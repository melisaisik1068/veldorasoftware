...
const services = [
  ...
  },
  {
    ...
    description:
      'Design system kurulumu, component kütüphanesi ve performans odaklı render stratejisi.',
    features: [
  ...
  },
  {
    ...
    description:
      'Mevcut sitenizi Core Web Vitals hedeflerine taşıyorum. Bundle analizi ve ISR stratejisi.',
  ...
  },
  {
    ...
    title: 'DevOps & Cloud',
    description:
      'CI/CD pipeline kurulumu, Docker konteynerizasyon ve cloud deployment otomasyonu. Vercel, GCP ve AWS üzerinde production-ready altyapı.',
    features: [
